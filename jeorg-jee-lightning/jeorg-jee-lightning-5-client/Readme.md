...
This is the client for project [jee-lightning-5](../jeorg-jee-lightning-5).

Topics:

## Endpoints

1.  [http://localhost:8080/jeorg-jee-lightning-4-1.0.0-SNAPSHOT](http://localhost:8080/jeorg-jee-lightning-4-1.0.0-SNAPSHOT)
