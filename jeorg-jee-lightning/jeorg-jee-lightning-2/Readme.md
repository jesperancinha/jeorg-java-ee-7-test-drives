...
http://localhost:8080/jeorg-jee-lightning-2-1.0.0-SNAPSHOT/

```bash
curl --header "Content-Type: text/xml;charset=UTF-8" --header "SOAPAction:helloPortBinding" --data @message1.xml http://localhost:8080/jeorg-jee-lightning-2-1.0.0-SNAPSHOT/hello?wsdl
```
