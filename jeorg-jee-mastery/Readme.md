...
To further deepen our understanding of JEE7, we will go through mastery modules. These modules serve the purpose of exploring in depth, the knowledge acquired from buiilding the [jeorg-jee-apps](../jeorg-jee-apps).
...
### [jeorg-jee-mastery-app-1](./jeorg-jee-mastery-app-1) - PRIDE Edition 1 🏳️‍🌈

### [jeorg-jee-mastery-app-2](./jeorg-jee-mastery-app-2) - Chorus and Arias 🎶 🔉
